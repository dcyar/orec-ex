...
<div class="d-flex align-items-center justify-content-start pd-r-20 mg-b-20 mg-sm-b-30">
    <div class="btn-group hidden-xs-down">
        <div class="br-pagetitle">
            ...
            <div>
                <h4>Certificado de Solteria</h4>
                <p class="mg-b-0">Certificados de solteria emitidas por esta OREC.</p>
            </div>
        </div>
    </div>
    <!-- btn-group -->
    <div class="mg-l-auto hidden-xs-down">
        ...
        <a href="#" class="btn btn-info" data-toggle="modal" data-target="#nuevaActa">Nuevo Certificado</a>
    </div>
</div>
<!-- d-flex -->
    ...
    <div class="br-section-wrapper">
        ...
        <div class="bd bd-gray-300 rounded table-responsive">
            <table class="table table-striped table-bordered table-colored table-dark mg-b-0">
                ...
                <tbody>
                    @foreach ($singlenesses as $singleness)
                        <tr>
                            <th scope="row">{{ $singleness->id }}</th>
                            <td>{{ $singleness->nombres . ' ' . $singleness->apellidos }}</td>
                            <td>{{ $singleness->dni }}</td>
                            <td>{{ $singleness->fecha_de_expedicion }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
