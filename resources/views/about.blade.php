...
<div class="br-pagebody">
    <div class="card shadow-base bd-0 mg-t-20 widget-4">
        ...
        <div class="card-body">
            ...
            <hr />
            <p class="wd-md-500 mg-md-l-auto mg-md-r-auto mg-b-25"><a href="https://github.com/dcyar/orec-ex" target="_blank"><strong>OREC EX</strong></a> es un proyecto de codigo abierto (Open Source), enfocado a facilitar el proceso de digitalización, emisión y control de actas de nacimientos, matrimonios y defunciones.</p>
            <span>Link del Proyecto:</span>
            <p class="mg-b-0 tx-24">
                <a href="https://www.github.com/dcyar/orec-ex" class="tx-primary mg-r-5" target="_blank"><i class="fab fa-github"></i></a>
            </p>
        </div>
        <!-- card-body -->
    </div>
